...
{
    public class InitialLocalizationOfFigures : IInitialLocalizationOfFigures
    {
        public InitialLocalizationHelper[] GetInitialLocalizationArray()
        {
            InitialLocalizationHelper[] initialLocalizations =
            {
